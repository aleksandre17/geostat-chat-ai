...
public class EntityPromptTemplate {
    ...
    void load() throws IOException {
        ...
        root = mapper.readValue(
                new ClassPathResource("prompts/enrichment/entities.yaml").getInputStream(), PromptRoot.class);
    }
    ...
    public String user(String title, String sectionPath, String language, String contentText) {
        return root.user()
